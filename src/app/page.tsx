        ...
        <div className="mx-auto w-full max-w-2xl space-y-8">
          <div className="gap-2 flex justify-between">
            ...
            <BlurFade delay={BLUR_FADE_DELAY}>
              <Avatar className="w-32 h-auto border">
      ...
      <section id="skills">
        <div className="flex min-h-0 flex-col gap-y-4">
          <BlurFade delay={BLUR_FADE_DELAY * 9}>
            ...
            <p className="mt-2">
              A creative and adaptable developer with 2 years of experience in software development. Experienced in both
              Frontend and Backend technologies, with hands-on experience across various languages, frameworks, and
              tools.
            </p>
            <p className="mt-2">
              Passionate about continuous learning and exploring new technologies in the ever-evolving tech landscape.
            </p>
          </BlurFade>

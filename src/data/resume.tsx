...
export const DATA = {
  name: "Khoi Nguyen",
  initials: "KN",
  url: "https://nguyendev.site",
  location: "Ho Chi Minh City, Vietnam",
  description: "Frontend Developer with 2 years of hands-on experience in web application development.",
  summary:
    "I have experience in develop web application using modern technologies like JavaScript, TypeScript, React.js, Next.js and NodeJS. Experienced in building RESTful API backend systems using Python (FastAPI) and Node.js (ExpressJS). I have experience in blockchain and smart contract development using Solidity, Hardhat, Ethers.js, Wagmi, and Viem to build dApps. Experienced in implement staking, yield farming, liquidity pool system. Build system interact crypto trading platform such as Hyperliquid, Ostium...",
  avatarUrl: "/me.jpg",
  skills: {
    languages: ["JavaScript", "TypeScript", "Solidity", "Python", "HTML", "CSS"],
    frontend: ["React", "Next.js", "TailwindCSS", "Shadcn UI", "Vite", "Redux", "React Query", "Zustand"],
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/khoinguyen1207",
        icon: Icons.github,
        navbar: true,
        isExternal: true,
      },
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/n-khoi-nguyen",
        icon: Icons.linkedin,
        navbar: true,
        isExternal: true,
      },
      Email: {
        name: "Email",
        url: `mailto:khoinguyentpvl@gmail.com`,
        icon: Icons.email,
        navbar: true,
        isExternal: false,
      },
  ...
  education: [
    {
      ...
      href: "https://www.vlu.edu.vn/en",
      degree: "Sortware Engineer",
      logoUrl: "/university-logo.jpg",
      start: "2020",
      end: "2024",
    },
  ],
